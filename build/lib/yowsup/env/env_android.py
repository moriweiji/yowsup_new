...
class AndroidYowsupEnv(YowsupEnv):
    ...
    _MD5_CLASSES = "/LTJhhsrbwUXo1aKkUjYCA=="
    _KEY = "eQV5aq/Cg63Gsq1sshN9T3gh+UUp0wIw0xgHYT1bnCjEqOJQKCRrWxdAe2yvsDeCJL+Y4G3PRD2HUF7oUgiGo8vGlNJOaux26k+A2F3hj8A=" #"eQV5aq/Cg63Gsq1sshN9T3gh+UUp0wIw0xgHYT1bnCjEqOJQKCRrWxdAe2yvsDeCJL+Y4G3PRD2HUF7oUgiGo8vGlNJOaux26k+A2F3hj8A=" #"eQV5aq/Cg63Gsq1sshN9T3gh+UUp0wIw0xgHYT1bnCjEqOJQKCRrWxdAe2yvsDeCJL+Y4G3PRD2HUF7oUgiGo8vGlNJOaux26k+A2F3hj8A="
    _VERSION = "2.23.16.77"
    _OS_NAME = "Android"
    _OS_VERSION = "8.0.0" #"9.0.0"
    _DEVICE_NAME = "star2lte" #"Galaxy S20 Ultra 5G"
    _MANUFACTURER = "samsung"
    _BUILD_VERSION = "star2ltexx-user 8.0.0 R16NW G965FXXU1ARCC release-keys" #"z3qksx-user 9 PPR1.180720.122 6736742 release-keys"
    _AXOLOTL = True
